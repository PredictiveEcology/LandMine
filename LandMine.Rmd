...
bibliography: citations/bibliography.bib
citation-style: citations/ecology-letters.csl
editor_options: 
  chunk_output_type: console
---

```{r pkg_install, eval=FALSE, echo=FALSE}
...
```{r moduleInputs-LandMine, echo = FALSE, eval = TRUE, message = FALSE}
df_inputs <- SpaDES.core::moduleInputs("LandMine", moduleDir)[, c(1, 3)]  ## name + desc only
knitr::kable(df_inputs,
             caption = "LandMine module input objects and their descriptions.") %>%
...
```{r moduleParams-LandMine, echo = FALSE, eval = TRUE, message = FALSE}
df_params <- SpaDES.core::moduleParams("LandMine", moduleDir)[, c(1, 6)] ## name + desc only
knitr::kable(df_params,
             caption = "LandMine module parameters and their descriptions.") %>%
  kableExtra::kable_styling(latex_options = c("scale_down", "repeat_header"), full_width = TRUE) %>%
...
df_outputs <- SpaDES.core::moduleOutputs("LandMine", moduleDir)[, c(1, 3)] ## name + desc only
knitr::kable(df_outputs,
             caption = "LandMine output objects and their description.") %>%
  kableExtra::kable_styling(latex_options = c("scale_down", "repeat_header"), full_width = TRUE) %>%
  kableExtra::column_spec(column = 2, width = "40em")
```
