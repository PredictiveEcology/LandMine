...
date: "18 May 2018; updated 22 Oct 2025"
output:
...
Require::Require(
  packages = c("dplyr", "DEoptim", "igraph", "kableExtra",
               "LandWebUtils", "rmarkdown", "SpaDES.core", "terra"),
  install = FALSE,
  update = FALSE
)
...
optimParams <- read.csv(DEoptim_file)
